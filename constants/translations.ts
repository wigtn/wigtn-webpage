export const TRANSLATIONS = {
  ...
  productDetail: {
    ...
    features: {
      ...
      wigtnflake_feature_anomaly: "ANOMALY_DETECTION promoted from supporting role to demo lead: it automatically injects 'watch this district' badges into the ranking. The 'wait, something's happening here' moment that anchors the demo.",
