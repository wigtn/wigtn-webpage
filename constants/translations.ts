  ...
  ko: {
    ...
    team: {
      bios: [
        ...
        "LLM 기반 애플리케이션과 자율 에이전트 시스템 구축에 집중하는 AI 엔지니어입니다. 대규모 언어 모델을 활용하여 실제 문제를 해결하는 지능형 워크플로우 설계에 열정을 가지고 있습니다.",
  ...
  ja: {
    ...
    team: {
      bios: [
        ...
        "LLMベースのアプリケーションと自律エージェントシステムの構築に注力するAIエンジニア。大規模言語モデルを活用し、実際の問題を解決するインテリジェントなワークフロー設計に情熱を持っています。",
