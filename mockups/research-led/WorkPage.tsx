...
/** /work (nav: "Projects") — everything we've built and shared, grouped. */
      ...
      <section className="max-w-6xl mx-auto px-6 pb-32 pt-4">
        {WORK_GROUPS.map((g) => (
          <div key={g.label} className="mt-16 first:mt-4 md:mt-24">
            <h2 className="text-[clamp(1.75rem,4vw,2.5rem)] font-bold tracking-[-0.02em] leading-tight text-brand-light">
              {g.label}
            </h2>
