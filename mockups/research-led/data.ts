...
export const ARTICLES: Article[] = [
  ...
  },
  {
    ...
    body: [
      ...
      { t: "list", items: [
        "557 ms average latency across 148 production calls",
        "Software-only echo cancellation — zero echo-loop incidents, no dedicated hardware",
        "$0.27 per minute, built on the OpenAI Realtime API and Twilio Media Streams",
      ] },
      {
        t: "gallery",
        images: [
  ...
  },
  {
    ...
    body: [
      ...
      p(
        "Pick a goal — open a cafe, place a billboard, invest — and a GPT-4o orchestrator summons five purpose-tuned experts who debate in a Slack-style chat while Cortex Analyst runs text-to-SQL across four Semantic Models: foot traffic, real estate, markets, and telecom.",
      ),
      { t: "list", items: [
