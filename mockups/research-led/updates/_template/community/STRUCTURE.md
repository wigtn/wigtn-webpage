...
- **Do not name attendees.** Speakers, yes, with their talk. Everyone else came
  to a meetup, not to a press event.
- **Do not photograph the room in a way that identifies people who did not
  present.** Wide shots from behind, or nothing.
- **Do not publish a recap without section 6.** A community post with no next
  date is a closing announcement, whatever it says.
