 ...
 *
 * NO COVER. The photographs are on the blog post, taken for it.
 *
 * FACTS, all from the story post (../trae-seoul-grand-prize, on this site's
 * blog since the stories came back): 2026.03.28, Seoul, Grand
 ...
 * as a redirect, and the story itself lives at /blog under it now. Reusing it
...
export const traeSeoul2026GrandPrize: Article = {
  ...
  links: [{ label: "Read the write-up", href: blogHref("trae-seoul-grand-prize") }],
  body: [
    p(
