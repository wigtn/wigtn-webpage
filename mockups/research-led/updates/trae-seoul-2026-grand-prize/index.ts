 ...
 *
 * NO COVER. The photographs are on the feed post, taken for it.
 *
 * FACTS, all from the feed post (wigtn-tech-report,
 * components/feed/posts/trae-seoul-grand-prize.ts): 2026.03.28, Seoul, Grand
 ...
 * shorter one is taken: it was this site's URL for the story that has since
 * moved to the feed, and it is in RETIRED as a redirect. Reusing it would turn
 * a working redirect into a page that quietly replaces the thing it redirected
 * to.
 */
...
export const traeSeoul2026GrandPrize: Article = {
  ...
  links: [{ label: "Read the write-up", href: techFeedHref("trae-seoul-grand-prize") }],
  body: [
    p(
