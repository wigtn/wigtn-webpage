 ...
 *
 * FACTS, all from the story post (../oba-weekendthon-top6, on this site's
 * blog since the stories came back): 2026.05.31, Kakao AI Campus
 ...
 * RETIRED redirect to the blog story.
 */
...
export const obaWeekendthon2026Top6: Article = {
  ...
  links: [{ label: "Read the write-up", href: blogHref("oba-weekendthon-top6") }],
  body: [
    p(
